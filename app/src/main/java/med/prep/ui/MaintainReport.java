...
public class MaintainReport extends Reports {
    ...
    private String ltrModel(UniversalModel model, long restdays) {
        String html = "";
        ...
        {// outline table
            ...
            {// inner table
                ...
                {// text table
                    ...
                    // *** subject ***
                    html += "<tr>";
                    html += "<th colspan='2' style='text-align:left;font-size:19'><br>" + model.getSubject() + " " + model.getContent() + "</th>";
                    html += "</tr>";
